...
generated/Spotify/Api.elm: build/spotify-web-api-fixed.yaml Makefile
	yarn elm-open-api --module-name Spotify build/spotify-web-api-fixed.yaml

build/spotify-web-api-fixed.yaml: build/spotify-web-api-original.yaml src/api-patch.diff Makefile
	cp $< $@
	patch $@ src/api-patch.diff

src/api-patch.diff: # build/spotify-web-api-original.yaml build/spotify-web-api-fixed.yaml
